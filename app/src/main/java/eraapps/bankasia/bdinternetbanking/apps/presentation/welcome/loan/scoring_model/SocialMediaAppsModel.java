...
public class SocialMediaAppsModel {

    DatabaseHelper db;
    Context context;

    public SocialMediaAppsModel(Context context){
        this.context = context ;
    }
    public Integer socialMediaAppsModel() {
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                        ...
                        if(valScoreFlag.contains("0")){
                            for (Value vl : values) {
                                if((varID == vl.get_value_variable_id()) && varName.contains("Social Media Apps"))
                                {
                                    valFlag = valFlag + 1;
...
//        textViewStatus.setText(listApplicationInfo.size() + " Apps are installed");
        ...
        int social_media_apps_score = 0;
        int social_media_apps_count = 0;
        ...
        for (int i = 0; i < packList.size(); i++) {
            ...
            if(apps[i].contains(valName1.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore1);
                social_media_apps_count++;
            }
            else if (apps[i].contains(valName2.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore2);
                social_media_apps_count++;
            }
            else if (apps[i].contains(valName3.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore3);
                social_media_apps_count++;
            }
            else if (apps[i].contains(valName4.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore4);
                social_media_apps_count++;
            }
            else if (apps[i].contains(valName5.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore5);
                social_media_apps_count++;
            }
            else if (apps[i].contains(valName6.toLowerCase())){
                social_media_apps_score = Integer.parseInt(valScore6);
                social_media_apps_count++;
            }
            else if(social_media_apps_count>=5){
                social_media_apps_score = Integer.parseInt(valScore6);
            }

        }
        Log.d("Score",String.valueOf(social_media_apps_score));
...
//        }
    ...
    return social_media_apps_score;
    }

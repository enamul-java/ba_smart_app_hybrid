...
class StandingInstructionExecute @Inject constructor(
    ...
    operator fun invoke( header: Map<String,String>, fundTransferOwnBankRequest: OwnBankRequestModel): Flow<Resource2<CommonProcedureDto>> = flow {
        try {
            val response = fundTransferOwnBankRepository.standingInstructionExecute(header,fundTransferOwnBankRequest)

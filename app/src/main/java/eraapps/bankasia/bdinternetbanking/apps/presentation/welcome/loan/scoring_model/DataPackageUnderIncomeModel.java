...
public class DataPackageUnderIncomeModel {
    DatabaseHelper db;
    Context context;
    ...
    public DataPackageUnderIncomeModel(Context context){
        this.context = context;
    }

    public HashMap<String, String> dataPackageUnderIncomeModel(ArrayList<SMSModel> SMSArrayList) {
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                            ...
                            if(valScoreFlag.contains("0")){
                                for (Value vl : values) {
                                    if((varID == vl.get_value_variable_id()) && varName.contains("Mobile Data Package "))
                                    {
                                        valFlag = valFlag + 1;
...
//            }
            ...
            Log.d("Total_prepaid_","Totalamount: "+Total_prepaid_package_amount);
            ...
            Log.d("Total_prepaid_","Total_prepaid_package_amount: "+Total_prepaid_package_amount);
            Log.d("data_package_score","data_package_score: "+data_package_score);
            DATAPACKAGE_score.put("Data package amount (income model): "+ String.valueOf(Total_prepaid_package_amount)+" MB",String.valueOf(data_package_score));

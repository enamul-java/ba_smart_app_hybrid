...
import eraapps.bankasia.bdinternetbanking.apps.presentation.welcome.loan.adapter.LoanStatusListAdaptar
...
@AndroidEntryPoint
class LoanStatus : AppCompatActivity() {
    ...
    private lateinit var mAdapter: LoanStatusListAdaptar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lo_settlement_type.visibility = View.GONE
        ...
        toolbar_title.text = "Loan Payment Status"


        iv_header_back.setOnClickListener {
            val intent = Intent(this@LoanStatus, LoanDashboardActivity::class.java)
            CustomActivityClear.doClearActivity(intent, this@LoanStatus)
        }

        if (!CustomAlert.isOnline(this@LoanStatus)) {
    ...
    fun populateLoanList(actionFlag:String){
        ...
        mAdapter =
            LoanStatusListAdaptar(loanList,
                object : LoanStatusListAdaptar.OnItemClickListener{
                override fun onItemClick(item: LoanListResponseModel,actionFlag: String, payableAmount: Double) {
                 Log.e("",item.toString())
                    ...
                    try {
                       dueOrPrincipalAmount = amount.toDouble()
                    }catch (e:Exception){
    ...
    private fun showDialogDestAcc(actionFlag: String, dueOrPrincipalAmount:String, payableAmount:String) {
        ...
        if(actionFlag.equals("P")){
            ...
            tv_interest_amount.setText(intAmount)

...
class AccountStatement@Inject constructor(
    ...
    operator fun invoke( header: Map<String,String>,accountRequestModel: AccountRequestModel): Flow<Resource2<CommonProcedureDto>> = flow {
        try {
            ...
            val accountStatementResponse = accountRepository.accountStatement(header,accountRequestModel)
            emit(Resource2.Success(accountStatementResponse))

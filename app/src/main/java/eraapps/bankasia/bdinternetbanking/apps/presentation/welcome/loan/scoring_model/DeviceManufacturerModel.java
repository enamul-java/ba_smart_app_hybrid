...
public class DeviceManufacturerModel {DatabaseHelper db;
    Context context;

    public DeviceManufacturerModel(Context context){
        this.context = context ;
    }
    public Integer deviceManufacturerModel() {
        int DeviceManufacturerScore = 0;
        try {
            int compID;
            String compName;
            int varID;
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                            ...
                            if (valScoreFlag.contains("0")) {
                                for (Value vl : values) {
                                    if ((varID == vl.get_value_variable_id()) && varName.contains("Manufacturer Name")) {
                                        valFlag = valFlag + 1;
...
/*
            Log.e("manufacturer-001 ",manufacturer);
            Log.e("valName1-001 ",valName1.toLowerCase());
            Log.e("valName2-001 ",valName2.toLowerCase());
            Log.e("valName3-001 ",valName3.toLowerCase());
            Log.e("valName4-001 ",valName4.toLowerCase());
            Log.e("valName5-001 ",valName5.toLowerCase());
            Log.e("valName6-001 ",valName6.toLowerCase());
            */
          ...
          //  String b = "SAMSUNG";
            ...
            if(valName1.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore1);
            } else  if(valName2.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore2);
            }else if(valName3.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore3);
            }else if(valName4.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore4);
            }else if(valName5.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore5);
            }else if(valName6.toLowerCase().startsWith(manufacturer.toLowerCase())){
                DeviceManufacturerScore = Integer.parseInt(valScore6);
            } else{
                DeviceManufacturerScore = Integer.parseInt(valScore6);
            }
               //
          ...
          /*  if (manufacturer.contains(valName1) ){
                DeviceManufacturerScore = Integer.parseInt(valScore1);
            }
            else if (manufacturer.contains(valName2) ){
                DeviceManufacturerScore = Integer.parseInt(valScore2);
            }
            else if (manufacturer.equals(valName3)){
                DeviceManufacturerScore = Integer.parseInt(valScore3);
            }
            else if (manufacturer.contains(valName4)){
                DeviceManufacturerScore = Integer.parseInt(valScore4);
            }
            else if (manufacturer.contains(valName5) ){
                DeviceManufacturerScore = Integer.parseInt(valScore5);
            }
            else if (manufacturer.contains(valName6) ){
                DeviceManufacturerScore = Integer.parseInt(valScore6);
            }
            else{
                DeviceManufacturerScore = Integer.parseInt(valScore6);
            ...
            */
            ...
            Log.d("manufacturer","manufacturer: " +manufacturer);
        ...
        return DeviceManufacturerScore;
    }
}

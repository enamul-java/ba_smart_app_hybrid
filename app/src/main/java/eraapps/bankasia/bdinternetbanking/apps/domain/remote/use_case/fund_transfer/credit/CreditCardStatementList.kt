...
class CreditCardStatementList @Inject constructor(
    ...
    ): Flow<Resource<List<CreditCardStatementDto>>> = flow {
        try {
            val response =
                creditCardRepository.creditCardStatementList(header, requestModel)

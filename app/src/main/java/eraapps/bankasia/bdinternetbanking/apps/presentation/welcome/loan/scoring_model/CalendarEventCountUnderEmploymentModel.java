...
public class CalendarEventCountUnderEmploymentModel {
...
//    public static String descriptions = "";
    ...
    public CalendarEventCountUnderEmploymentModel(Context context) {
        this.context = context;
    }

    public Integer calendarEventCountUnderEmploymentModel() {
        int month;
        int year;
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                        ...
                        if(valScoreFlag.contains("0")){
                            for (Value vl : values) {
                                if((varID == vl.get_value_variable_id()) && varName.contains("No. of Calender Event/Month "))
                                {
                                    valFlag = valFlag + 1;

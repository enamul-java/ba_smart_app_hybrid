...
class ChequeStatusSearchList @Inject constructor(
    ...
    ): Flow<Resource<List<ChequeStatusModel>>> = flow {
        try {
            emit(Resource.Loading())
            val response = chequeRepository.chequeStatusSearchList(header, accountRequestModel)

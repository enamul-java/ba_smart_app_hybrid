...
public class DeviceOsVersionModel {
    DatabaseHelper db;
    Context context;

    public DeviceOsVersionModel(Context context){
        this.context = context ;
    }
    public Integer deviceOSModel() {
        int deviceOSscore = 0;
        try {
            int compID;
            String compName;
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                            ...
                            if (valScoreFlag.contains("0")) {
                                for (Value vl : values) {
                                    if ((varID == vl.get_value_variable_id()) && varName.contains("Device OS Version")) {
                                        valFlag = valFlag + 1;
            ...
            String versionRelease ="Android "+ Build.VERSION.RELEASE;
            Log.d("version","v:"+versionRelease);
            Log.d("version","v:"+valName4);

            if (versionRelease.contains(valName1) ){
                deviceOSscore = Integer.parseInt(valScore1);
            }
            else if (versionRelease.contains(valName2) ){
                deviceOSscore = Integer.parseInt(valScore2);
            }
            else if (versionRelease.equals(valName3)){
                deviceOSscore = Integer.parseInt(valScore3);
            }
            else if (versionRelease.contains(valName4)){
                deviceOSscore = Integer.parseInt(valScore4);
            }
            else if (versionRelease.contains(valName5) ){
                deviceOSscore = Integer.parseInt(valScore5);
            }
            else if (versionRelease.contains(valName6) ){
...
//        Log.d("deviceOSscore","deviceOSscore: " +deviceOSscore);

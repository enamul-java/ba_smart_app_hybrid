...
import eraapps.bankasia.bdinternetbanking.apps.domain.remote.model.vcard.VCardDetailsDataM
...
class VirtualCardCarouselAdapter(
    private val carouselDataList: ArrayList<VCardDetailsDataM>,
                          actvt: AppCompatActivity,
                          context: Context,
                          cardHeight : Int, cardWidth: Int) :
    RecyclerView.Adapter<VirtualCardCarouselAdapter.CarouselItemViewHolder>() {
     var ctx: Context
    ...
    override fun onBindViewHolder(holder: CarouselItemViewHolder, position: Int) {
        ...
        constraintLayout.setBackgroundResource(R.drawable.virtual_card_background2)

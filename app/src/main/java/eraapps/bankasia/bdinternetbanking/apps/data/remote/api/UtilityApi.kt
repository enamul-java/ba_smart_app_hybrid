...
interface UtilityApi {
    ...
    @POST("v1/electricity-bill-payment/bill-info")
    ...
    @POST("v1/utility-report/bills-report")
    ...
    @POST("v1/utility-report/bills-report-list")
    ...
    @POST("v1/electricity-bill-payment/bill-payment")

...
public class CreditCardRepaymentBehaviour {

    DatabaseHelper db;
    Context context;
    public CreditCardRepaymentBehaviour(Context context){
        this.context = context ;
    }

    public HashMap<String,String> creditCardRepaymentBehaviour(ArrayList<SMSModel> SMSArrayList) {
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                            ...
                            if(valScoreFlag.contains("0")){
                                for (Value vl : values) {
                                    if((varID == vl.get_value_variable_id()) && varName.contains("Credit Card Repayment Behavior"))
                                    {
                                        valFlag = valFlag + 1;
            ...
            CREDIT_DEBIT_score.put("Credit Card repayment_behaviour (Employment): " + String.valueOf(repayment_behaviour), String.valueOf(repayment_behaviour_score));

...
class RetrofitExceptionHandle(
    ...
    companion object {
        fun httpError(
            ...
            response: Response<*>,
            retrofit: Retrofit,
        ): RetrofitExceptionHandle {
            val message = response.code().toString() + " " + response.message()
            return RetrofitExceptionHandle(message, url, response, Kind.HTTP, null, retrofit)
        }
        ...
        fun httpErrorWithObject(
            ...
            val message = response.code().toString() + " " + response.message()
            val error =
                RetrofitExceptionHandle(message,
                    url,
                    response,
        ...
        fun networkError(exception: IOException): RetrofitExceptionHandle {
            return RetrofitExceptionHandle(exception.message,
                null,
                null,
                Kind.NETWORK,
                exception,
        ...
        fun unexpectedError(exception: Throwable): RetrofitExceptionHandle {
            return RetrofitExceptionHandle(exception.message,
                null,
                null,
                Kind.UNEXPECTED,
    ...
    private fun deserializeServerError() {
        if (_response != null && _response.errorBody() != null) {
            try {
                ...
                Log.e("Retrofit servererror deserialization", e.message.toString())
            }
        }
    }

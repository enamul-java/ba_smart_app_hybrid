...
public class DeviceOperatingSystemModel {DatabaseHelper db;
    Context context;

    public DeviceOperatingSystemModel(Context context){
        this.context = context ;
    }
    public Integer deviceOperatingSystemModel() {
        int deviceOperatingSystemScore = 0;
        try {
            int compID;
            String compName;
            int varID;
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                            ...
                            if (valScoreFlag.contains("0")) {
                                for (Value vl : values) {
                                    if ((varID == vl.get_value_variable_id()) && varName.contains("Operating System")) {
                                        valFlag = valFlag + 1;
            ...
            if (deviceType.contains(valName1) ){
                deviceOperatingSystemScore = Integer.parseInt(valScore1);
            }
            else if (deviceType.contains(valName2) ){
                deviceOperatingSystemScore = Integer.parseInt(valScore2);
            }
            else if (deviceType.equals(valName3)){
                deviceOperatingSystemScore = Integer.parseInt(valScore3);
            }
            else if (deviceType.contains(valName4)){
                deviceOperatingSystemScore = Integer.parseInt(valScore4);
            }
            else if (deviceType.contains(valName5) ){
                deviceOperatingSystemScore = Integer.parseInt(valScore5);
            }
            else if (deviceType.contains(valName6) ){
                deviceOperatingSystemScore = Integer.parseInt(valScore6);
            }
//            else{
//                deviceOSscore = Integer.parseInt(valScore6);
//            }

            Log.d("deviceOperatingSystemScore","deviceOperatingSystemScore: " +deviceOperatingSystemScore);
        ...
        return deviceOperatingSystemScore;
    }
}

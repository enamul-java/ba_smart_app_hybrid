...
public class CalendarEventCountUnderSocialCapitalModel {
...
//    public static String descriptions = "";
    ...
    public CalendarEventCountUnderSocialCapitalModel(Context context) {
        this.context = context;
    }

    public Integer calendarEventCountUnderSocialCapitalModel() {
        int month;
        int year;
...
//                                    Log.d("asd","check: "+vl.get_min_value());
                        ...
                        if(valScoreFlag.contains("0")){
                            for (Value vl : values) {
                                if((varID == vl.get_value_variable_id()) && varName.contains("No. of calender events/month"))
                                {
                                    valFlag = valFlag + 1;

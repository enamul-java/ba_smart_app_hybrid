...
class AccountStatementList @Inject constructor(
    ...
    ): Flow<Resource2<List<AccountStatementDto>>> = flow {
        try {

            val response = accountRepository.accountStatementList(header, accountRequestModel)

...
class CreditCardDestinationList @Inject constructor(
    ...
    ): Flow<Resource<List<CreditCardOptions>>> = flow {
        try {
            val response =
                creditCardRepository.creditCardDestinationList(header, requestModel)
